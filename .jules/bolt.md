...
## 2025-12-19 - [Fused Loops in Vector Normalization]
**Learning:** Separating filling and normalization loops for vectors added ~40% overhead (257ms vs 184ms for 4096 dimensions) due to double iteration and division cost.
**Action:** Fuse vector operations into a single loop where possible and pre-calculate inverse norms to replace division with multiplication.
