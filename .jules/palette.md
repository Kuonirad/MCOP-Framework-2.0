...
## 2025-12-23 - Keyboard Parity for Micro-interactions
**Learning:** Delightful hover animations (like translating arrows) are often invisible to keyboard users, creating a second-class experience.
**Action:** Always mirror `group-hover` animations with `group-focus-visible` (e.g., `group-focus-visible:translate-x-1`) to ensure keyboard users receive the same feedback.
