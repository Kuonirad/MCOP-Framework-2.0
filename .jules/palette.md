...
## 2025-12-23 - Focus Visible Micro-interactions
**Learning:** Visual micro-interactions mapped exclusively to hover states (like translating an arrow) fail to provide an equitable experience for keyboard users navigating via Tab.
**Action:** Always pair hover micro-interactions with their `focus-visible` equivalents (e.g., `group-hover:translate-x-1 group-focus-visible:translate-x-1`) to ensure accessibility for all users.
