...
export default function Home() {
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main id="main-content" tabIndex={-1} className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start focus:outline-none">
        ...
        <nav aria-label="Quick actions" className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            title="Deploy your Next.js app to Vercel"
          >
            <Image
              aria-hidden="true"
              className="dark:invert"
