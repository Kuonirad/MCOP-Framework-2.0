...
export class NovaNeoEncoder {
  ...
  estimateEntropy(tensor: ContextTensor): number {
    ...
    // Optimization: Standard for loops and direct multiplication are significantly faster
    // than Array.prototype.reduce and Math.pow(x, 2) in V8 for mathematical operations
    let sum = 0;
