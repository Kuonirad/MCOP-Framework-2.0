...
export class NovaNeoEncoder {
  ...
  estimateEntropy(tensor: ContextTensor): number {
    ...
    // Optimized: Use standard for-loops and direct multiplication instead of reduce() and Math.pow()
    // to significantly reduce function call overhead and closure allocations in V8.
