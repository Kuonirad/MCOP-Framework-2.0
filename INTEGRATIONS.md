...
| 2 | **Devin Sub-Agents** | Orchestration Case Study | Live | [`src/adapters/devinOrchestratorAdapter.ts`](src/adapters/devinOrchestratorAdapter.ts) · [`examples/devin_sub_agent_orchestration/orchestrator.ts`](examples/devin_sub_agent_orchestration/orchestrator.ts) | [`docs/integrations/devin_sub_agents.md`](docs/integrations/devin_sub_agents.md) | `aa5b47b2…529007` |
| 3 | **Linear + Slack via MCP** | Orchestration Case Study | Live | [`src/adapters/linearSlackOrchestratorAdapter.ts`](src/adapters/linearSlackOrchestratorAdapter.ts) · [`examples/linear_slack_mcp_orchestrator.ts`](examples/linear_slack_mcp_orchestrator.ts) | [`docs/integrations/linear_slack_mcp.md`](docs/integrations/linear_slack_mcp.md) | `9325b794…1fb29cacd` |
