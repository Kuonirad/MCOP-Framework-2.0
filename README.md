...
Cryptographic lineage at every step. **91.42%** test coverage.
...
| Test coverage on documented API surface | **91.42%** | varies | varies | varies |
...
# 4. Run the deterministic Jest suite — 91.42% covered (≈20 s)
pnpm test
...
[![Jest](https://img.shields.io/badge/Jest-91.42%25-c21325?style=for-the-badge&logo=jest)](./jest.config.js)
