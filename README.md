...
Cryptographic lineage at every step. **90.91%** test coverage.
...
| Test coverage on documented API surface | **90.91%** | varies | varies | varies |
...
# 4. Run the deterministic Jest suite — 90.91% covered (≈20 s)
pnpm test
...
[![Jest](https://img.shields.io/badge/Jest-90.91%25-c21325?style=for-the-badge&logo=jest)](./jest.config.js)
