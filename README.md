...
Cryptographic lineage at every step. **91.24%** test coverage.
...
| Test coverage on documented API surface | **91.24%** | varies | varies | varies |
...
# 4. Run the deterministic Jest suite — 91.24% covered (≈20 s)
pnpm test
...
[![Jest](https://img.shields.io/badge/Jest-91.24%25-c21325?style=for-the-badge&logo=jest)](./jest.config.js)
