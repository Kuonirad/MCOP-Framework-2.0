...
function TweaksPanel({ title = 'Tweaks', noDeckControls = false, children }) {
  // Outside the design-tool iframe, no host will post __activate_edit_mode,
  // so default to open when standalone. The dismiss button still hides it.
  const __standalone = typeof window !== 'undefined' && window.parent === window;
