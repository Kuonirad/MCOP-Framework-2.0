...
- Node.js version is pinned to **22.22.3** via `.nvmrc` and `engines` in `package.json`.
...
```bash
ln -sf ../lib/node_modules/pnpm/bin/pnpm.cjs /home/ubuntu/.nvm/versions/node/v22.22.3/bin/pnpm
```
